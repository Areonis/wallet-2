...
import logo3 from '../../assets/1/3.png'
  ...
  return (
    <div className={styles.root}>
      <div className={styles.content}>
        ...
        <Item item={items[2]} className="span 2" />
        <Item item={items[3]} className="" />
        <Item item={items[4]} className="" />
        <Item item={items[5]} className="span 2" />
        <Item item={items[6]} className="" />
        <Item item={items[7]} className="" />
      </div>
